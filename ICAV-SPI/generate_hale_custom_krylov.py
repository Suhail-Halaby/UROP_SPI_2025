...
n_step = 5
structural_relaxation_factor = 0.25
relaxation_factor = 0.10
tolerance = 1e-4
fsi_tolerance = 1e-3
num_cores = 2

chord_ref = 0.25 # Wing reference chord. Used for reduced frequency normalisation
rom_settings = dict()
rom_settings['algorithm'] = 'mimo_rational_arnoldi'  # reduction algorithm
rom_settings['r'] = 8  # Krylov subspace order
    ...
    settings['LinearAssembler'] = {'linear_system': 'LinearAeroelastic',
                                   'linear_system_settings': {
                                       'beam_settings': {'modal_projection': True,
                                                         ...
                                                         'remove_dofs': []},
                                       'aero_settings': {'dt': dt,
                                                         'ScalingDict': {'length': 0.5 * chord_ref,
                                                                      'speed': u_inf,
                                                                      'density': rho},
                                                         'integr_order': 2,
                                                         'density': rho,
